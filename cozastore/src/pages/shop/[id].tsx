...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  if (id) {
    ...
    const product: ProductItemType = await res.json();

    const resRelaetd = await fetch(
      `http://localhost:5001/products?_start=$%7BrandomNo%7D&_limit=4`
    );
    const relatedProducts: ProductItemType[] = await resRelaetd.json();
